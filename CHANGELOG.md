...
- About dialog now shows the Redocly and Monaco Editor versions powering Spec
  Sanity
...
- Plain English explanations for validation errors — technical messages now show
  a human-friendly description so non-technical users can understand what's
...
- Validation runs in your browser — lint results show up faster
...
- Rule presets: minimal, recommended, and all rules
