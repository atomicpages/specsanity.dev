import { version as redoclyVersion } from "@redocly/openapi-core/package.json";
import { X } from "lucide-react";
import { version as monacoEditorVersion } from "monaco-editor/package.json";
    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className="mt-4 flex flex-col gap-3 text-sm leading-relaxed text-foreground">
          <p>
            An OpenAPI spec is a file that describes how an API works. Spec
            Sanity helps you check that file before you share it.
          </p>
          <p>
            Add your spec from a link, paste it in, or upload a file. Spec
            Sanity checks it in your browser against common API guidelines and
            shows anything that may need attention.
          </p>
        </div>
        <section
        ...
        >
          <h3 id="powered-by-heading" className="text-sm font-semibold">
            Powered by
          </h3>
          <p className="mt-2 text-sm text-muted-foreground">
            <a
              href="https://www.npmjs.com/package/@redocly/openapi-core"
              target="_blank"
              rel="noopener noreferrer"
              className="underline underline-offset-4 transition-colors hover:text-foreground"
            >
              Redocly v{redoclyVersion}
            </a>{" "}
            and{" "}
            <a
              ...
              className="underline underline-offset-4 transition-colors hover:text-foreground"
            >
              Monaco Editor v{monacoEditorVersion}
            </a>
            .
          </p>
        </section>
